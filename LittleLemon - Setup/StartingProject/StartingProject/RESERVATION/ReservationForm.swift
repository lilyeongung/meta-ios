        ...
        VStack {
            Form {
                ...
                HStack {
                    VStack (alignment: .leading) {
                        ...
                        if #available(iOS 17.0, *) {
                            ...
                            // MARK: - Task 7: TextField Validation
                            //  number keypad allows the typing of 0, which is not an acceptable number of persons for a reservation
                            // add a modifier here that checks if the typed value is 0 and corrects it to 1.
                            .onChange(of: party) { oldValue, newValue in
                ...
                Group{
                    ...
                    // MARK: - Task 8: Run validateForm when selected
            ...
            // MARK: - Task 9: Show an alert if the form validation fails
